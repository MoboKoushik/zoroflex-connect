...
import { fetchFullInvoices } from './dump_data/invoiceFullService';
import { fetchFromTally, XML_COMPANY_LIST } from "./dump_data/tallyClient";
// import { fetchAllLedgers } from './fetchLedgers';
import { fetchAllVouchers } from './dump_data/fetchAllVouchers';
import { fetchAllVouchersODBC } from './dump_data/fetchVouchersODBC';
import { fetchReceipts } from './dump_data/fetchReceiptsXML';
import { fetchAllLedgers } from './fetch-to-tally/fetchLedgers';
import { fetchAllLedgersOpening } from './dump_data/fetchLedegerOpeningAndCurrentBalence';
import { fetchAllCompaniesWithSelected } from './dump_data/fetchAllCompanies';
...
import { fetchAllVouchersWithItems } from './dump_data/fetchAllVouchersWithItems';
import { getMinMaxAlterId } from './dump_data/getMinMaxAlterId';
...
export class SyncService {
  ...
  private async fullSync(profile: UserProfile, type: 'MANUAL' | 'BACKGROUND' = 'BACKGROUND'): Promise<void> {
    ...
    try {
      ...
      // const result = await fetchAllVouchersWithItems();
      // console.log('Total Vouchers fetched:', result.length);
      // console.log('First invoice sample:', JSON.stringify(result, null, 2));
